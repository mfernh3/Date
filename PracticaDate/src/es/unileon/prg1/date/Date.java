...
public class Date {
	...
	public Date(int day, int month, int year){
		this.year = year;
		if (month < 1 || month > 12) {
			System.out.println("Mes " + month + " no valido" +
		...
		switch(month){
			...
			case 12:
				if((day>=1) && (day<=31)){
					...
					System.out.println("Dia " + day + " no valido para el mes " + month + ", valores posibles entre 1 y 31.");
				}
				break;
			case 4: //next
			case 6: //next
			...
			case 11:
				if((day>=1) && (day<=30)){
					...
					System.out.println("Dia " + day + " no valido para el mes " + month + ", valores posibles entre 1 y 30.");
				}
				break;
			case 2:
				if((day>=1) && (day<=28)){
					...
					System.out.println("Dia " + day + " no valido para el mes " + month + ", valores posibles entre 1 y 28.");
				}
				break;
		}
	}
